...
export function PartnerLinkingScreen({ userId, onPartnerLinked }: PartnerLinkingScreenProps) {
  ...
  return (
    <View className="flex-1 bg-cream">
      ...
      <View className="bg-cream-dark px-4 py-6 border-b border-cream-dark">
        <Text className="text-2xl font-serif font-bold text-wine">Relational Handshake</Text>
        <Text className="text-charcoal/60 mt-1">Connect your journey with your partner</Text>
      </View>
